...
some NAs are real, because the mean is zero
...
if mean is zero and sd is NA then cannot compute s
for correlation if one effect size is missing then lose the point 